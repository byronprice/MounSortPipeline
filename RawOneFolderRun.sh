...
ml-run-process ms4alg.sort --inputs timeseries:pre.mda.prv --outputs firings_out:rawfire.mda --parameters detect_sign:-1 adjacency_radius:-1 detect_threshold:1.5
